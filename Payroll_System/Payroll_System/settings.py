...
INSTALLED_APPS = [
    'payroll',  # Ensure this app is added
...
# Specify where Django will look for static files
STATICFILES_DIRS = [
    BASE_DIR / 'payroll' / 'static',  # Ensure this points to the correct static folder inside the app
]
